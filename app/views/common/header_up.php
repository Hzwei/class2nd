...
<head>
	...
	<script type="text/javascript">
		var baseUrl = "<?php echo base_url(); ?>";	// 定义全局网站地址
	</script>
	<script src='<? echo base_url(); ?>static/js/user.js'></script>
	<script src='<? echo base_url(); ?>static/js/common.js'></script>